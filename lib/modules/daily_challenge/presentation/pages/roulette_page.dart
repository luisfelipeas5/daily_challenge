...
import 'package:daily_challenge/modules/daily_challenge/presentation/widgets/coins_background/roulette_coins_background.dart';
import 'package:daily_challenge/shared/widgets/star_in_blue_background/star_in_blue_background.dart';
...
class _RoulettePageState extends State<RoulettePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StarInBlueBackground(
        child: RouletteCoinsBackground(
          child: SafeArea(
